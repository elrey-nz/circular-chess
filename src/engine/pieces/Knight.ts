...
// Precalculated attack tables for Knights
let knightAttacks: Bitboard[] | null = null;

const initKnightAttacks = () => {
    if (knightAttacks !== null) return;
    knightAttacks = new Array(TOTAL_SQUARES).fill(Bitboard.empty());
...
export class Knight extends Piece {
    ...
    getMoves(_coord: Coordinate, _gameState: GameStateForPieces): Bitboard {
        // Knights only have attacks, no separate moves
